...
directives. This single GraphQL schema is the main output of the Schema
Composition and represents the Gateway Configuration. The schema composition
process is divided into three major algorithms, `Validate Subgraphs`,
`Merge Subgraphs` and `Validate Satisfiability` that are run in order.
